        ...
        <div style={{
            ...
            >
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#fff', marginBottom: '0.5rem' }}>Welcome Back</h1>
                    <p style={{ color: '#86868b' }}>Please sign in to your account</p>
                </div>
                ...
                <div style={{ marginTop: '2.5rem', textAlign: 'center' }}>
                    <p style={{ color: '#86868b', fontSize: '0.95rem' }}>
                        ...
                        <Link href="/register" style={{ color: '#ff9f0a', textDecoration: 'none', fontWeight: '500' }}>
                            Sign up
                        </Link>
                    </p>
                </div>
